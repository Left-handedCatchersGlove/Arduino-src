========================================================================
    Win32 アプリケーション: RS232C-TEST01 プロジェクトの概要
========================================================================

この RS232C-TEST01 アプリケーションは、AppWizard により作成されました。

このファイルには、RS232C-TEST01 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


RS232C-TEST01.vcxproj
...
RS232C-TEST01.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル RS232C-TEST01.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル RS232C-TEST01.rc 
    にインクルードされます。
